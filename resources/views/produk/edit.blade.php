...
@section('container')
    ...
    <div class="col-lg-8">
        ...
        <form method="post" action="/produk/{{ $produk->id_produk }}" class="mb-5">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="kategori_id">
                    @foreach ($kategori as $kategori)
                        @if ((old('kategori_id') == $produk->kategori->kategori_id) == $kategori->id_kategori)
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="status_id">
                    @foreach ($status as $status)
                        @if ((old('status_id') == $produk->status->status_id) == $status->id_status)
            ...
            <div class="mb-3">
                ...
                <input type="number"
                    ...
                    is-invalid
                @enderror"
                    id="harga" name="harga" required autofocus value="{{ old('harga', $produk->harga) }}">
                @error('harga')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
